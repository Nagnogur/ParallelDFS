...
namespace ParallelDFS
{
    public static class Settings
    {
        ...
        public const string GRAPH_FILE_PATH = "graph2.txt";
        public const bool GRAPH_WRITE_TO_FILE = false;
        public const string GRAPH_WRITE_PATH = "graph2.txt";
        ...
        public const int NUMRETRY = 3;
        public const int CUTOFFDEPTH = 20;
